...
export default function AgentsTable() {
    ...
    const { currentPage, setCurrentPage, itemsPerPage, setItemsPerPage, clampToTotalPages } =
        useTablePage("admin-sales-dashboard-deleted-advisor-page");
                ...
                <div className="flex flex-col gap-4 md:flex-row md:justify-between md:items-center mb-6">
                    <div>
                        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold break-words">
                            Deleted Client Advisor Management
                        </h1>
                        ...
                        {loading ? (
                            ...
                            <div className="flex flex-col items-start gap-2 md:gap-4">
                                <div className="w-full">
                                    <Label htmlFor="search" className="text-sm sm:text-base">Search Deleted Client Advisors</Label>
                ...
                <CardHeader>
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <CardTitle className="flex items-center gap-2 text-lg sm:text-xl">
                            ...
                            <span className="truncate">Deleted Client Advisors ({sortedAgents.length})</span>
                        </CardTitle>
                    </div>
                </CardHeader>
