    ...
    <div className="block md:hidden">
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <div className="flex-1 min-w-0">
          <h2 className="text-lg font-bold truncate">{agentData.name}</h2>
          <div className="flex flex-wrap gap-2 mt-1">
            {getAgentTypeBadge(agentData.agentType)}
            <Badge
              variant={
                agentData.status === "Active" ? "default" : "secondary"
              }
            >
              {agentData.status}
            </Badge>
      ...
      {/* Mobile Contact Info - moved to top */}
      <div className="space-y-2 text-sm text-muted-foreground mb-4">
        <div className="flex items-center gap-2">
          <Mail className="h-4 w-4 flex-shrink-0" />
          <span className="truncate">{agentData.email}</span>
        </div>
        <div className="flex items-center gap-2">
      ...
      <div className="grid grid-cols-2 gap-4 p-3 bg-gray-50 rounded-lg">
        <div className="text-center">
          <div className="text-xl font-bold text-blue-600">
            {agentData.stats.completedTasks}
          </div>
          <div className="text-xs text-gray-500">Completed</div>
        </div>
        <div className="text-center">
          <div className="text-xl font-bold text-green-600">
            {agentData.stats.completionRate}%
          </div>
    ...
    <div className="hidden md:block lg:hidden">
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          {/* Tablet Contact Info - moved to top */}
          <div className="space-y-2 text-sm text-muted-foreground mb-4">
            <div className="flex items-center gap-2">
              <Mail className="h-4 w-4 flex-shrink-0" />
              <span className="truncate">{agentData.email}</span>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Progress
                      value={agentData.stats.completionRate}
                      className="h-2"
                    />
                  </div>
                </CardContent>
        ...
        <TabsContent value="tasks" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                All tasks currently assigned to {agentData.name}
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="team" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Team members reporting to {agentData.name}
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="rounded-md border">
