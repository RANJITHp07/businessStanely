...
import { Bold, Italic, Underline, List, ListOrdered, Heading1, Heading2, Plus, Save, Trash2 } from "lucide-react"
...
export default function DiaryPage() {
    ...
    const fetchNotes = async () => {
        try {
            ...
            const fetchedNotes: DiaryNote[] = Array.isArray(data.entries) ? data.entries : []
        ...
        <div className="h-screen flex bg-white">
            ...
            <div className="flex-1 flex flex-col">
                ...
                <div className="border-b p-4 flex gap-2 flex-wrap">
                    ...
                    <Button size="sm" variant="outline" onClick={handleDelete} disabled={!selectedNoteId}>
