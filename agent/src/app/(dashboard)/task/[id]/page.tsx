        ...
        const fetchTaskDetails = async () => {
            try {
                ...
                if (data.task.timeLogs) {
                    ...
                    const total = data.task.timeLogs.reduce((sum: number, log: TimeLogData) => sum + log.hours, 0);
                        ...
                        <CardContent className="space-y-6">
                            ...
                            <div className="space-y-3">
                                ...
                                <Button
                                    ...
                                    disabled={!timeLogDate || !timeLogHours || !timeLogDescription || submittingTimeLog}
                                    className="w-full"
                                >
                                        ...
                                        <div key={log.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                            <div className="flex-1">
                                                ...
                                                <div className="text-xs text-gray-500">
                                                    By {log.agent.name} on {new Date(log.date).toLocaleDateString()}
                                                </div>
                                            </div>
                                            <div className="flex items-center gap-2">
