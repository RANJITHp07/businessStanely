        ...
        <div className="min-h-screen  bg-[#e3f2fd] p-6 md:p-8">
            <div className="mx-auto max-w-7xl space-y-6">
                ...
                <div className="space-y-2">
                    <h1 className="text-3xl font-bold tracking-tight text-slate-900">Prospect Management</h1>
                    <p className="text-slate-600">
                        {statusFromUrl ? `Showing ${statusFromUrl} prospects` : "Manage and track all prospects and leads"}
                    </p>
                </div>
                    ...
                    {loading ? (
                        ...
                        <>
                            <CardHeader>
                                ...
                                <CardDescription className="text-slate-600">Filter and search through your prospects</CardDescription>
                            </CardHeader>
