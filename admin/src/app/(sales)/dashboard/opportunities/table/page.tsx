        ...
        fetch(`/api/opportunities?assignedAgentId=${assignedId || ""}`)
            ...
            .then(data => {
                if (data.opportunities) {
                    setProspects(data.opportunities);
                } else {
                    setProspects([]);
                }
                setLoading(false);
            ...
            <div className="mb-8">
                <div className="flex flex-col md:flex-row justify-between md:items-center mb-6 md:mb-4">
                    <div>
                        ...
                        <p className="text-muted-foreground mt-2">Manage and track all opportunities</p>
                    </div>
                </div>
                                            ...
                                            currentProspects.map((prospect) => (
                                                <TableRow key={prospect.id} className="cursor-pointer" >
                                                    ...
                                                    <TableCell onClick={() => router.push(`/dashboard/opportunities/${prospect.id}`)}>
                                                        <Badge
                                                            className={
                                                                prospect.status === "Proposal Issued"
                                                                    ? "bg-purple-100 text-purple-800"
                                                                    : prospect.status === "Closed as Loss"
                                                    ...
                                                    <TableCell className="text-right">
                                                        <DropdownMenu>
                                                            ...
                                                            <DropdownMenuContent align="end">
                                                                ...
                                                                <DropdownMenuItem onClick={() => router.push(`/dashboard/opportunities/${prospect.id}`)}>
                                                                    <Eye className="mr-2 h-4 w-4" />
                                                                    View
                                                                </DropdownMenuItem>
                                                                <DropdownMenuItem onClick={() => router.push(`/dashboard/prospects/${prospect.prospect?.id}/edit`)}>
